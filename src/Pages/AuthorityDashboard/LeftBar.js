  ...
  const NavBar = [
    {
      ...
      link:
        currentNav.loginType === "Explorers"
          ? "/Explorersdashboard"
          : "/authoritydashboard",
    },
    {
    ...
    },
    {
      ...
      link: currentNav.loginType === "Explorers" ? "/Explorerschat" : "/authoritychat",
    },
    {
      title: "History",
      icon: (
    ...
    {
      title: "Location Near me",
      icon: (
        <Map
          style={{
            padding: ".5rem 0",
            width: "2rem",
            color: currentNav.current === "Location Near me" && "blue",
            borderBottom:
              currentNav.current === "Location Near me" && "1px solid blue",
          }}
        />
      ),
      link: "/locationMap",
