...
function DeleteParent({ openPopUp, setOpenPopup, selected }) {
  ...
  const deleteParent = async () => {
    try {
      ...
      if (deleteParent) {
        enqueueSnackbar("Parent Delete Succesful", { variant: "success" });
        ParentRefetch();
        setOpenPopup(false);
      }
      ...
      enqueueSnackbar("Parent delete Failed", { variant: "error" });
    }
  };
